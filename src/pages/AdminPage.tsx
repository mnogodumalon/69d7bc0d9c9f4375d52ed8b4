...
const RISIKOBEHANDLUNGMASSNAHMENPLAN_FIELDS = [
  { key: 'massnahme_is_risiko', label: 'Bezogenes Informationssicherheitsrisiko', type: 'applookup/select', targetEntity: 'informationssicherheitsrisiken', targetAppId: 'INFORMATIONSSICHERHEITSRISIKEN', displayField: 'is_risiko_name' },
  { key: 'massnahme_name', label: 'Maßnahmenbezeichnung', type: 'string/text' },
  { key: 'massnahme_beschreibung', label: 'Beschreibung', type: 'string/textarea' },
  { key: 'massnahme_behandlungsoption', label: 'Behandlungsoption', type: 'lookup/select', options: [{ key: 'vermeiden', label: 'Vermeiden' }, { key: 'akzeptieren', label: 'Akzeptieren' }, { key: 'transferieren', label: 'Transferieren' }, { key: 'mitigieren', label: 'Mitigieren' }] },
  { key: 'massnahme_prioritaet', label: 'Priorität', type: 'lookup/select', options: [{ key: 'niedrig', label: 'Niedrig' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }, { key: 'kritisch', label: 'Kritisch' }] },
  { key: 'massnahme_verantwortlicher_vorname', label: 'Vorname des Verantwortlichen', type: 'string/text' },
  { key: 'massnahme_verantwortlicher_nachname', label: 'Nachname des Verantwortlichen', type: 'string/text' },
  { key: 'massnahme_geplantes_datum', label: 'Geplantes Umsetzungsdatum', type: 'date/date' },
  { key: 'massnahme_tatsaechliches_datum', label: 'Tatsächliches Umsetzungsdatum', type: 'date/date' },
  { key: 'massnahme_status', label: 'Status der Maßnahme', type: 'lookup/select', options: [{ key: 'geplant', label: 'Geplant' }, { key: 'in_umsetzung', label: 'In Umsetzung' }, { key: 'umgesetzt', label: 'Umgesetzt' }, { key: 'abgebrochen', label: 'Abgebrochen' }, { key: 'ueberprueft', label: 'Überprüft' }] },
  { key: 'massnahme_wirksamkeit', label: 'Wirksamkeitsprüfung', type: 'lookup/select', options: [{ key: 'nicht_bewertet', label: 'Nicht bewertet' }, { key: 'wirksam', label: 'Wirksam' }, { key: 'teilweise_wirksam', label: 'Teilweise wirksam' }, { key: 'nicht_wirksam', label: 'Nicht wirksam' }] },
  { key: 'massnahme_wirksamkeitsdatum', label: 'Datum der Wirksamkeitsprüfung', type: 'date/date' },
  { key: 'massnahme_kontrolle', label: 'Verknüpfte Sicherheitskontrolle', type: 'applookup/select', targetEntity: 'sicherheitskontrollen', targetAppId: 'SICHERHEITSKONTROLLEN', displayField: 'kontrolle_name' },
  { key: 'massnahme_restrisiko', label: 'Restrisiko nach Behandlung', type: 'lookup/select', options: [{ key: 'niedrig', label: 'Niedrig' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }, { key: 'kritisch', label: 'Kritisch' }] },
  { key: 'massnahme_nachweis', label: 'Nachweis / Dokumentation', type: 'file' },
  { key: 'massnahme_notizen', label: 'Notizen', type: 'string/textarea' },
];
...
const INTERNEAUDITS_FIELDS = [
  ...
  { key: 'audit_typ', label: 'Audit-Typ', type: 'lookup/select', options: [{ key: 'intern', label: 'Internes Audit' }, { key: 'extern', label: 'Externes Audit' }, { key: 'zertifizierung', label: 'Zertifizierungsaudit' }, { key: 'ueberwachung', label: 'Überwachungsaudit' }, { key: 'sonstiges', label: 'Sonstiges' }] },
...
const RISIKOBEWERTUNG_FIELDS = [
  ...
  { key: 'risiko_kategorie', label: 'Risikokategorie', type: 'lookup/select', options: [{ key: 'betrieblich', label: 'Betrieblich' }, { key: 'rechtlich', label: 'Rechtlich / Compliance' }, { key: 'finanziell', label: 'Finanziell' }, { key: 'reputationell', label: 'Reputationell' }, { key: 'technisch', label: 'Technisch' }, { key: 'sonstiges', label: 'Sonstiges' }, { key: 'informationssicherheit', label: 'Informationssicherheit' }] },
...
const INFORMATIONSSICHERHEITSRISIKEN_FIELDS = [
  { key: 'is_risiko_name', label: 'Risiko-Bezeichnung', type: 'string/text' },
  { key: 'is_risiko_beschreibung', label: 'Beschreibung', type: 'string/textarea' },
  { key: 'is_bedrohungsquelle', label: 'Bedrohungsquelle', type: 'lookup/select', options: [{ key: 'extern', label: 'Extern' }, { key: 'menschlich', label: 'Menschlich' }, { key: 'technisch', label: 'Technisch' }, { key: 'organisatorisch', label: 'Organisatorisch' }, { key: 'umwelt', label: 'Umwelt' }, { key: 'sonstiges', label: 'Sonstiges' }, { key: 'intern', label: 'Intern' }] },
  { key: 'is_bedrohungsart', label: 'Bedrohungsart', type: 'lookup/select', options: [{ key: 'malware', label: 'Malware' }, { key: 'phishing', label: 'Phishing' }, { key: 'social_engineering', label: 'Social Engineering' }, { key: 'datendiebstahl', label: 'Datendiebstahl' }, { key: 'sabotage', label: 'Sabotage' }, { key: 'ausfall', label: 'Ausfall' }, { key: 'sonstiges', label: 'Sonstiges' }] },
  { key: 'is_schwachstelle', label: 'Schwachstelle', type: 'string/textarea' },
  { key: 'is_betroffenes_asset', label: 'Betroffenes Asset', type: 'applookup/select', targetEntity: 'assets', targetAppId: 'ASSETS', displayField: 'asset_name' },
  { key: 'is_mitigierende_kontrolle', label: 'Mitigierende Kontrolle', type: 'applookup/select', targetEntity: 'sicherheitskontrollen', targetAppId: 'SICHERHEITSKONTROLLEN', displayField: 'kontrolle_name' },
  { key: 'is_relevante_compliance', label: 'Relevante Compliance-Anforderung', type: 'applookup/select', targetEntity: 'compliance_anforderungen', targetAppId: 'COMPLIANCE_ANFORDERUNGEN', displayField: 'anforderung_name' },
  { key: 'is_vertraulichkeit', label: 'Auswirkung auf Vertraulichkeit', type: 'lookup/radio', options: [{ key: 'keine', label: 'Keine' }, { key: 'gering', label: 'Gering' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }] },
  { key: 'is_integritaet', label: 'Auswirkung auf Integrität', type: 'lookup/radio', options: [{ key: 'keine', label: 'Keine' }, { key: 'gering', label: 'Gering' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }] },
  { key: 'is_verfuegbarkeit', label: 'Auswirkung auf Verfügbarkeit', type: 'lookup/radio', options: [{ key: 'keine', label: 'Keine' }, { key: 'gering', label: 'Gering' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }] },
  { key: 'is_eintrittswahrscheinlichkeit', label: 'Eintrittswahrscheinlichkeit', type: 'lookup/radio', options: [{ key: 'sehr_gering', label: 'Sehr gering' }, { key: 'gering', label: 'Gering' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }, { key: 'sehr_hoch', label: 'Sehr hoch' }] },
  { key: 'is_gesamtrisiko', label: 'Gesamtrisiko', type: 'lookup/radio', options: [{ key: 'niedrig', label: 'Niedrig' }, { key: 'mittel', label: 'Mittel' }, { key: 'hoch', label: 'Hoch' }, { key: 'kritisch', label: 'Kritisch' }] },
  { key: 'is_behandlung', label: 'Risikobehandlung', type: 'lookup/select', options: [{ key: 'akzeptieren', label: 'Akzeptieren' }, { key: 'mitigieren', label: 'Mitigieren' }, { key: 'vermeiden', label: 'Vermeiden' }, { key: 'transferieren', label: 'Transferieren' }] },
  { key: 'is_status', label: 'Status', type: 'lookup/select', options: [{ key: 'offen', label: 'Offen' }, { key: 'in_behandlung', label: 'In Behandlung' }, { key: 'akzeptiert', label: 'Akzeptiert' }, { key: 'geschlossen', label: 'Geschlossen' }] },
  { key: 'is_verantwortlicher_vorname', label: 'Vorname des Verantwortlichen', type: 'string/text' },
  { key: 'is_verantwortlicher_nachname', label: 'Nachname des Verantwortlichen', type: 'string/text' },
  { key: 'is_bewertungsdatum', label: 'Bewertungsdatum', type: 'date/date' },
  { key: 'is_naechste_bewertung', label: 'Nächste Bewertung', type: 'date/date' },
  { key: 'is_notizen', label: 'Notizen', type: 'string/textarea' },
];

const ENTITY_TABS = [
  { key: 'risikobehandlung_&_maßnahmenplan', label: 'Risikobehandlung & Maßnahmenplan', pascal: 'RisikobehandlungMassnahmenplan' },
  ...
  { key: 'informationssicherheitsrisiken', label: 'Informationssicherheitsrisiken', pascal: 'Informationssicherheitsrisiken' },
] as const;
...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<EntityKey>('risikobehandlung_&_maßnahmenplan');
  const [selectedIds, setSelectedIds] = useState<Record<EntityKey, Set<string>>>(() => ({
    'risikobehandlung_&_maßnahmenplan': new Set(),
    'compliance_anforderungen': new Set(),
    'interne_audits': new Set(),
    'sicherheitskontrollen': new Set(),
    'assets': new Set(),
    'risikobewertung': new Set(),
    'informationssicherheitsrisiken': new Set(),
  }));
  ...
  const getRecords = useCallback((entity: EntityKey) => {
    switch (entity) {
      case 'risikobehandlung_&_maßnahmenplan': return (data as any).risikobehandlungMassnahmenplan as RisikobehandlungMassnahmenplan[] ?? [];
      ...
      case 'informationssicherheitsrisiken': return (data as any).informationssicherheitsrisiken as Informationssicherheitsrisiken[] ?? [];
      default: return [];
    }
  }, [data]);
  ...
  const getLookupLists = useCallback((entity: EntityKey) => {
    ...
    switch (entity) {
      case 'risikobehandlung_&_maßnahmenplan':
        lists.informationssicherheitsrisikenList = (data as any).informationssicherheitsrisiken ?? [];
      ...
      case 'risikobewertung':
        ...
        lists.sicherheitskontrollenList = (data as any).sicherheitskontrollen ?? [];
        break;
      case 'informationssicherheitsrisiken':
        lists.assetsList = (data as any).assets ?? [];
        lists.sicherheitskontrollenList = (data as any).sicherheitskontrollen ?? [];
        lists.compliance_anforderungenList = (data as any).complianceAnforderungen ?? [];
        break;
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'risikobehandlung_&_maßnahmenplan' && fieldKey === 'massnahme_is_risiko') {
      const match = (lists.informationssicherheitsrisikenList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.is_risiko_name ?? '—';
    }
    if (entity === 'risikobehandlung_&_maßnahmenplan' && fieldKey === 'massnahme_kontrolle') {
    ...
    if (entity === 'informationssicherheitsrisiken' && fieldKey === 'is_betroffenes_asset') {
      const match = (lists.assetsList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.asset_name ?? '—';
    }
    if (entity === 'informationssicherheitsrisiken' && fieldKey === 'is_mitigierende_kontrolle') {
      const match = (lists.sicherheitskontrollenList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.kontrolle_name ?? '—';
    }
    if (entity === 'informationssicherheitsrisiken' && fieldKey === 'is_relevante_compliance') {
      const match = (lists.compliance_anforderungenList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.anforderung_name ?? '—';
    }
    return String(url);
  ...
  const getFieldMeta = useCallback((entity: EntityKey) => {
    switch (entity) {
      case 'risikobehandlung_&_maßnahmenplan': return RISIKOBEHANDLUNGMASSNAHMENPLAN_FIELDS;
      ...
      case 'informationssicherheitsrisiken': return INFORMATIONSSICHERHEITSRISIKEN_FIELDS;
      default: return [];
    }
  }, []);
  ...
  const getServiceMethods = useCallback((entity: EntityKey) => {
    switch (entity) {
      case 'risikobehandlung_&_maßnahmenplan': return {
        create: (fields: any) => LivingAppsService.createRisikobehandlungMassnahmenplanEntry(fields),
        update: (id: string, fields: any) => LivingAppsService.updateRisikobehandlungMassnahmenplanEntry(id, fields),
        remove: (id: string) => LivingAppsService.deleteRisikobehandlungMassnahmenplanEntry(id),
      };
      ...
      case 'informationssicherheitsrisiken': return {
        create: (fields: any) => LivingAppsService.createInformationssicherheitsrisikenEntry(fields),
        update: (id: string, fields: any) => LivingAppsService.updateInformationssicherheitsrisikenEntry(id, fields),
        remove: (id: string) => LivingAppsService.deleteInformationssicherheitsrisikenEntry(id),
      };
      default: return null;
    }
  }, []);
  ...
  return (
    ...
    >
      ...
      {(createEntity === 'risikobehandlung_&_maßnahmenplan' || dialogState?.entity === 'risikobehandlung_&_maßnahmenplan') && (
        <RisikobehandlungMassnahmenplanDialog
          open={createEntity === 'risikobehandlung_&_maßnahmenplan' || dialogState?.entity === 'risikobehandlung_&_maßnahmenplan'}
          onClose={() => { setCreateEntity(null); setDialogState(null); }}
          onSubmit={dialogState?.entity === 'risikobehandlung_&_maßnahmenplan' ? handleUpdate : (fields: any) => handleCreate('risikobehandlung_&_maßnahmenplan', fields)}
          defaultValues={dialogState?.entity === 'risikobehandlung_&_maßnahmenplan' ? dialogState.record?.fields : undefined}
          informationssicherheitsrisikenList={(data as any).informationssicherheitsrisiken ?? []}
      ...
      {(createEntity === 'informationssicherheitsrisiken' || dialogState?.entity === 'informationssicherheitsrisiken') && (
        <InformationssicherheitsrisikenDialog
          open={createEntity === 'informationssicherheitsrisiken' || dialogState?.entity === 'informationssicherheitsrisiken'}
          onClose={() => { setCreateEntity(null); setDialogState(null); }}
          onSubmit={dialogState?.entity === 'informationssicherheitsrisiken' ? handleUpdate : (fields: any) => handleCreate('informationssicherheitsrisiken', fields)}
          defaultValues={dialogState?.entity === 'informationssicherheitsrisiken' ? dialogState.record?.fields : undefined}
          assetsList={(data as any).assets ?? []}
          sicherheitskontrollenList={(data as any).sicherheitskontrollen ?? []}
          compliance_anforderungenList={(data as any).complianceAnforderungen ?? []}
      ...
      {viewState?.entity === 'risikobehandlung_&_maßnahmenplan' && (
        <RisikobehandlungMassnahmenplanViewDialog
          open={viewState?.entity === 'risikobehandlung_&_maßnahmenplan'}
          onClose={() => setViewState(null)}
          record={viewState?.record}
          onEdit={(r: any) => { setViewState(null); setDialogState({ entity: 'risikobehandlung_&_maßnahmenplan', record: r }); }}
          informationssicherheitsrisikenList={(data as any).informationssicherheitsrisiken ?? []}
          sicherheitskontrollenList={(data as any).sicherheitskontrollen ?? []}
        />
      )}
      ...
      {viewState?.entity === 'informationssicherheitsrisiken' && (
        <InformationssicherheitsrisikenViewDialog
          open={viewState?.entity === 'informationssicherheitsrisiken'}
          onClose={() => setViewState(null)}
          record={viewState?.record}
          onEdit={(r: any) => { setViewState(null); setDialogState({ entity: 'informationssicherheitsrisiken', record: r }); }}
          assetsList={(data as any).assets ?? []}
          sicherheitskontrollenList={(data as any).sicherheitskontrollen ?? []}
          compliance_anforderungenList={(data as any).complianceAnforderungen ?? []}
        />
