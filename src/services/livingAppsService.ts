...
import type { Assets, Sicherheitskontrollen, ComplianceAnforderungen, Risikobewertung, InterneAudits, CreateAssets, CreateSicherheitskontrollen, CreateComplianceAnforderungen, CreateRisikobewertung, CreateInterneAudits } from '@/types/app';
